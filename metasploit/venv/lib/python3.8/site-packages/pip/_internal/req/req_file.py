...
# Matches environment variable-style values1 in '${MY_VARIABLE_1}' with the
...
def parse_requirements(
    ...
    :param finder:      DockerServerInstance of pip.index.PackageFinder.
