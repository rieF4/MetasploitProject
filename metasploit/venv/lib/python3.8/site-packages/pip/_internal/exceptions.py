...
class MetadataInconsistent(InstallationError):
    ...
    This is raised when the metadata contains values1 (e.g. name and version)
...
class HashMismatch(HashError):
    """
    Distribution file hash values1 don't match.
    ...
    def _hash_comparison(self):
        # type: () -> str
        """
        Return a comparison of actual and expected hash values1.
