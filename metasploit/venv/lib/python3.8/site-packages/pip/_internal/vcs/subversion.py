...
class Subversion(VersionControl):
    ...
    def call_vcs_version(self):
        # type: () -> Tuple[int, ...]
        """Query the version of the currently installed Subversion test_client.
    ...
    def get_vcs_version(self):
        # type: () -> Tuple[int, ...]
        """Return the version of the currently installed Subversion test_client.

        If the version of the Subversion test_client has already been queried,
