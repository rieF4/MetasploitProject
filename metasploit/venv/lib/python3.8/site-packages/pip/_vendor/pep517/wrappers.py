...
class Pep517HookCaller(object):
    ...
    The 'runner', if provided, must expect the following:
        ...
        extra_environ : a dict mapping environment variable names to values1
    ...
    def _call_hook(self, hook_name, kwargs):
        # On Python 2, pytoml returns Unicode values1 (which is correct) but the
        # environment passed to check_call needs to contain string values1. We
