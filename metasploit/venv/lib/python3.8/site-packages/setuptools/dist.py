...
def check_extras(dist, attr, value):
    ...
    try:
        ...
        raise DistutilsSetupError(
            "'extras_require' must be a dictionary whose values1 are "
...
def check_package_data(dist, attr, value):
    ...
    for k, v in value.items():
        ...
        assert_string_list(dist, 'values1 of {!r} dict'.format(attr), v)
...
class Distribution(_Distribution):
    ...
    def _try_str(val):
        """
        On Python 2, much of distutils relies on string values1 being of
